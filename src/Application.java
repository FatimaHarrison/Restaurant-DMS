...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.print("Enter your role (Host/Manager): ");//Prompting user to insert their role.
        String role = scanner.nextLine().trim(); //Declare first
        //Only if host and manager can access the CLI.
        if (!role.equalsIgnoreCase("Host") && !role.equalsIgnoreCase("Manager")) {
            System.out.println("Access Denied");
            role = "Guest"; //Access won't be granted for guest and others.
        } else { //Prompting user to insert their ID number
        ...
        //display when your who you logged in as.
        ...
        while (true) {
            ...
            if (role.equalsIgnoreCase("Host")) {
                ...
                System.out.println("7. Exit");//Exit menu
            }
            //Custom end line
            System.out.print("---------------------:");
